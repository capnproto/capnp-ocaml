...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5fe2a13e6f1ab7639e193287ca8eb591) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "OCaml code generator plugin for the Cap'n Proto compiler";
          description = None;
          categories = [];
                      ...
                      bs_byteopt =
                        [
                           (OASISExpr.EBool true,
                             ["-g"; "-thread"; "-bin-annot"; "-short-paths"])
                        ];
                      bs_nativeopt =
                        [
                           (OASISExpr.EBool true,
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\169}\245\011\229\199\167\135\151\147\202\245\146g\232\138";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
