module type S = sig
  ...
  module MessageWrapper : MessageSig.S
  ...
  module Untyped : sig
    ...
    (** An untyped method. This will typically be something like
        ['a reader_t -> 'b StructRef.t * 'b Lwt.t]. i.e. the result of
    ...
    val abstract_method : ('a MessageWrapper.StructStorage.reader_t, 'b) Service.method_t -> abstract_method_t
...
module None (M : MessageSig.S) = struct
  ...
  module MessageWrapper = M

  type untyped_struct = [`No_RPC_struct]
  type untyped_cap = Uint32.t
